"""
Parent: group_go_7001.py
Goal: test if we have enough cpu time. Using fewer nodes and fewer markers. 
"""
import os
import sys
import time
...
def init(fn_hdf5, fn_profiles, fn_bfield, fn_geqdsk, eq_index):
    ...
    options_settings["my_max_simtime"]           = 0.3
    ...
    nrho_profiles = 101
    aa_markers = marker_sets.define_prt_markers_03(fn_hdf5, fn_geqdsk, marker_set, Nmrk, marker_settings, nrho_profiles) #desc=my_description)
