...
def define_prt_markers_uniform(settings):
    ...
    try:
        btor_multiplier        = settings["btor_multiplier"]         # allows us to change sign of B from what is in the fn_geqdsk
    except:
        btor_multiplier = 1.
    ...
    Pitch_min              = settings["Pitch_min"]               # pitch is defined as the component of alpha velocity along the magnetic field
                                                                 # to the total velocity (at birth).  so pitch=1.0 means that the alpha's velocity
    ...
    Ekev                   = settings["Ekev"]             # For DT-generated alphas, Ekev will be 3500.
    ...
    randomize_gyro         = settings["randomize_gyro"]   # deprecated 4/9/2023.  Assumed to be False going forward
                                                          # if True, then gyro angles will be chosen
                                                          # randomly. If False, then all gyro
                                                          # angles will be assigned the value gyro_fixed
    ...
    fn_hdf5                = settings["fn_hdf5"]          # name of ASCOT input file into which the marker info will
                                                          # be written
    ...
    ii_good  =   (marker_Rhos <=  birth_rhomax)    \  #  ii_good[ii] is True if the ii_th marker lies inside the plasma
